...
public class ContactServiceImpl implements ContactService {
    ...
    public ResponseEntity<ContactResponse> getContactDetails(Integer contactId) {
        ...
        if (contactDetails.isPresent()) {
            ...
            return new ResponseEntity<>(new ContactResponse(new Date(), MessageConstant.STATUS_200, MessageConstant.CONTACT_FETCHED,
                    contactDetails), HttpStatus.OK);
        } else {
            return new ResponseEntity<>(new ContactResponse(new Date(), MessageConstant.STATUS_404, MessageConstant.NO_DATA_FOUND,
                    new ContactDetails()), HttpStatus.BAD_REQUEST);
        }
    }
    ...
    public ResponseEntity<ContactResponse> deleteContactDetails(Integer contactId) {
        ...
        if (contactDetails.isPresent()) {
            ...
            return new ResponseEntity<>(new ContactResponse(new Date(), MessageConstant.STATUS_200, MessageConstant.CONTACT_DELETED), HttpStatus.OK);
        } else {
            return new ResponseEntity<>(new ContactResponse(new Date(), MessageConstant.STATUS_404, MessageConstant.NO_DATA_FOUND), HttpStatus.OK);
        }
    }
    ...
    public ResponseEntity<ContactResponse> updateContactDetails(Integer contactId, ContactRequest contactRequest) {
        ...
        if (contactDetails.isPresent()) {
            ...
            return new ResponseEntity<>(new ContactResponse(new Date(), MessageConstant.STATUS_200, MessageConstant.CONTACT_UPDATED,
                    contactDetails.get()), HttpStatus.OK);
        }
        return new ResponseEntity<>(new ContactResponse(new Date(), MessageConstant.STATUS_404, MessageConstant.NO_DATA_FOUND), HttpStatus.OK);
    }
